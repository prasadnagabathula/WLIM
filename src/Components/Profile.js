...
function Profile() {
  ...
  return (
    ...
    //         <IconButton component="span" sx={{ position: 'absolute', top: 150, right: 590 }}>
    //           <EditIcon />
    //         </IconButton>
    //       </label>
    //       <Typography sx={{ fontFamily: 'Montserrat', fontSize: '22px' }}>{name}</Typography>
    //     </Box>

    //     <Box sx={{ mt: 5, width: 600, display: 'flex', justifyContent: 'space-between' }}>
    //       <TextField
    //         label="Name"
    //         value={name}

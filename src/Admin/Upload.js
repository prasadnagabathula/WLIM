  ...
  //  setInputValue(''); 
    ...
    try {
      // console.log(formData);
        //const response = await axios.post('http://172.17.31.61:7215/api/IdentifiedItem', formData, {
        const response = await axios.post('http://localhost:7215/api/IdentifiedItem', formData, {
        headers: {
